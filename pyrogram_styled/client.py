...
from pyrogram_styled import __version__, __license__
from .formatter import Formatter as fmt
from pyrogram_styled import enums
from pyrogram_styled import raw
from pyrogram_styled import utils
from pyrogram_styled.crypto import aes
from pyrogram_styled.errors import CDNFileHashMismatch
...
from pyrogram_styled.handlers.handler import Handler
from pyrogram_styled.methods import Methods
from pyrogram_styled.session import Auth, Session
from pyrogram_styled.storage import SQLiteStorage, Storage
from pyrogram_styled.types import User, TermsOfService, Message, CallbackQuery
from pyrogram_styled.types.pyromod import ListenerTypes
from typing import Optional, Union    
from pyrogram_styled.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyrogram_styled.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyrogram_styled.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError(
                    ...
                    "More info: https://telegramplayground.github.io/pyrogram_styled/start/auth"
                )
    ...
    async def handle_download(self, packet):
        ...
        try:
            ...
            if isinstance(e, pyrogram_styled.errors.FloodWait):
                raise e
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyrogram_styled.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
