...
from pyrogram_styled.types import Update
...
class ErrorHandler(Handler):
    ...
    :meth:`~pyrogram_styled.Client.on_error` decorator.
    ...
    Other parameters:
        ...
        update (:obj:`~pyrogram_styled.Update`):
    ...
    async def check(self, client: pyrogram_styled.Client, update: Update, exception: Exception) -> bool:
