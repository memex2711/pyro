...
from pyrogram_styled.types import CallbackQuery, Identifier, Listener, ListenerTypes
...
class CallbackQueryHandler(Handler):
    ...
    It is intended to be used with :meth:`~pyrogram_styled.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~pyrogram_styled.Client.on_callback_query` decorator.
    ...
    Other parameters:
        client (:obj:`~pyrogram_styled.Client`):
            The Client itself, useful when you want to call other API methods inside the message handler.

        callback_query (:obj:`~pyrogram_styled.types.CallbackQuery`):
    ...
    def compose_data_identifier(query: CallbackQuery) -> Identifier:
        ...
        Parameters:
            query (:obj:`~pyrogram_styled.types.CallbackQuery`):
                The CallbackQuery object to compose of.

        Returns:
            :obj:`~pyrogram_styled.types.Identifier`: An Identifier object.
        """
    ...
    async def check_if_has_matching_listener(
        self, client: pyrogram_styled.Client, query: CallbackQuery
    ...
    async def check(self, client: pyrogram_styled.Client, query: CallbackQuery) -> bool:
        """
    ...
    async def resolve_future_or_callback(
        self, client: pyrogram_styled.Client, query: CallbackQuery, *args
    ) -> None:
        """
        ...
        if listener and listener_does_match:
            ...
            if listener.future and not listener.future.done():
                ...
                raise pyrogram_styled.StopPropagation
