...
from pyrogram_styled.types import Identifier, Listener, ListenerTypes, Message
...
class MessageHandler(Handler):
    ...
    :meth:`~pyrogram_styled.Client.on_message` decorator.
    ...
    Other parameters:
        ...
        message (:obj:`~pyrogram_styled.types.Message`):
    ...
    async def check_if_has_matching_listener(
        client: pyrogram_styled.Client, message: Message
    ...
    async def check(self, client: pyrogram_styled.Client, message: Message) -> bool:
        """
    ...
    async def resolve_future_or_callback(self, client: pyrogram_styled.Client, message: Message, *args):
        """
