...
class SetBotCommands:
    async def set_bot_commands(
        ...
        Parameters:
            commands (List of :obj:`~pyrogram_styled.types.BotCommand`):
                A list of bot commands.
                At most 100 commands can be specified.

            scope (:obj:`~pyrogram_styled.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~pyrogram_styled.types.BotCommandScopeDefault`.
        ...
        Example:
            .. code-block:: python
                ...
                from pyrogram_styled.types import BotCommand
