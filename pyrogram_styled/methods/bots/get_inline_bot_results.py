...
from pyrogram_styled.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyrogram_styled.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyrogram_styled.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("pyrogram_styledbot")
                print(results)
        """
