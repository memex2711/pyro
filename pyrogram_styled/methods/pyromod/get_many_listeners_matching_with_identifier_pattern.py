...
from pyrogram_styled.types import Identifier, Listener, ListenerTypes
...
class GetManyListenersMatchingWithIdentifierPattern:
    def get_many_listeners_matching_with_identifier_pattern(
        ...
        """
        Same of :meth:`pyrogram_styled.Client.get_listener_matching_with_identifier_pattern` but returns a list of listeners instead of one.

        Parameters:
            pattern (:obj:`~pyrogram_styled.types.Identifier`):
                Same as :meth:`pyrogram_styled.Client.get_listener_matching_with_identifier_pattern`.

            listener_type (:obj:`~pyrogram_styled.types.ListenerTypes`):
                Same as :meth:`pyrogram_styled.Client.get_listener_matching_with_identifier_pattern`.

        Returns:
            List[:obj:`~pyrogram_styled.types.Listener`]: A list of listeners that match the given identifier pattern.
        """
        return [
            listener
