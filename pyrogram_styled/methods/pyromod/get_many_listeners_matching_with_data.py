...
class GetManyListenersMatchingWithData:
    def get_many_listeners_matching_with_data(
        ...
        """
        Same of :meth:`pyrogram_styled.Client.get_listener_matching_with_data` but returns a list of listeners instead of one.

        Parameters:
            data (:obj:`~pyrogram_styled.types.Identifier`):
                Same as :meth:`pyrogram_styled.Client.get_listener_matching_with_data`.

            listener_type (:obj:`~pyrogram_styled.types.ListenerTypes`):
                Same as :meth:`pyrogram_styled.Client.get_listener_matching_with_data`.

        Returns:
            List[:obj:`~pyrogram_styled.types.Listener`]: A list of listeners that match the given data.
        """
        return [
            listener
