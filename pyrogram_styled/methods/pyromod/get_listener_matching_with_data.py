...
class GetListenerMatchingWithData:
    def get_listener_matching_with_data(
        self: pyrogram_styled.Client, data: Identifier, listener_type: ListenerTypes
    ) -> Listener | None:
        """
        ...
        Returns:
            :obj:`~pyrogram_styled.types.Listener`: The listener that matches the given data or ``None`` if no listener matches.
        """
        matching = [
            listener
