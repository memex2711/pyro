...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyrogram_styled.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyrogram_styled.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogram_styled.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyrogram_styled". Get the first 50 results
                async for message in app.search_global("pyrogram_styled", limit=50):
                    print(message.text)
