...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrogram_styled.types.InputMediaPhoto`, :obj:`~pyrogram_styled.types.InputMediaVideo`, :obj:`~pyrogram_styled.types.InputMediaAudio` and :obj:`~pyrogram_styled.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrogram_styled.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrogram_styled.types import InputMediaPhoto, InputMediaVideo
