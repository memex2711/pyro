...
from pyrogram_styled import StopTransmission, enums
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyrogram_styled.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrogram_styled.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrogram_styled.Client.stop_transmission`, None is returned.
