...
from pyrogram_styled.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyrogram_styled.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~pyrogram_styled.Client.stop_transmission`, None is returned.
