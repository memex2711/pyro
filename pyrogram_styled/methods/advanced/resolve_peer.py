...
class ResolvePeer:
    async def resolve_peer(
        ...
        .. note::
            ...
            :obj:`functions <pyrogram_styled.raw.functions>` (i.e: a Telegram API method you wish to use which is not
        ...
        Returns:
            :obj:`~pyrogram_styled.raw.base.InputPeer`: On success, the resolved peer id is returned in form of an InputPeer object.
