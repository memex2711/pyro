...
from pyrogram_styled import enums, raw, types, utils, StopTransmission
from pyrogram_styled.errors import FilePartMissing
...
class SendStory:
    async def send_story(
        ...
        Returns:
            :obj:`~pyrogram_styled.types.Story` a single story is returned.
