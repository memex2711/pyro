...
from pyrogram_styled.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyrogram_styled.Client.start`, :meth:`~pyrogram_styled.idle` and :meth:`~pyrogram_styled.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyrogram_styled.compose`.
