...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~pyrogram_styled.Client.stop` and then :meth:`~pyrogram_styled.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyrogram_styled.Client`: The restarted client itself.
