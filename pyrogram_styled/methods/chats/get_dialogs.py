...
from pyrogram_styled import types, raw, utils, enums
from pyrogram_styled.errors import ChannelPrivate, PeerIdInvalid
...
class GetDialogs:
    async def get_dialogs(
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogram_styled.types.Dialog` objects.
