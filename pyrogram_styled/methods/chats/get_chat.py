...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~pyrogram_styled.types.Chat` | :obj:`~pyrogram_styled.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("pyrogram_styled")
                print(chat)
        """
