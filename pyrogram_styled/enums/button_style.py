...
class ButtonStyle(AutoName):
    """Button style type enumeration used in :obj:`~pyrogram_styled.types.KeyboardButton` and :obj:`~pyrogram_styled.types.InlineKeyboardButton` to describe the style of a button."""
