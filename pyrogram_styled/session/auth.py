...
from pyrogram_styled.connection import Connection
from pyrogram_styled.crypto import aes, rsa, prime
from pyrogram_styled.errors import SecurityCheckMismatch
from pyrogram_styled.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrogram_styled.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
