...
from pyrogram_styled.crypto import mtproto
...
from pyrogram_styled.raw.all import layer
from pyrogram_styled.raw.core import FutureSalts, Int, MsgContainer, TLObject
...
class Session:
    ...
    async def handle_packet(self, packet):
        data = await self.client.loop.run_in_executor(
            pyrogram_styled.crypto_executor,
            mtproto.unpack,
            BytesIO(packet),
            self.session_id,
            self.auth_key,
