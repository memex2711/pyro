...
from pyrogram_styled import raw, enums, errors
...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~pyrogram_styled.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <pyrogram_styled.Filters.regex>`.
    """
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`~pyrogram_styled.types.CallbackQuery`.
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~pyrogram_styled.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~pyrogram_styled.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~pyrogram_styled.types.CallbackQuery`.
