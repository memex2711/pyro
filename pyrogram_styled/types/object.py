...
class Object:
    def __init__(self, client: "pyrogram_styled.Client" = None):
        self._client = client

    def bind(self, client: "pyrogram_styled.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~pyrogram_styled.types.Client`):
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/pyrogram_styledchat/167281
    ...
    def __repr__(self) -> str:
        return "pyrogram_styled.types.{}({})".format(
