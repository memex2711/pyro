...
class ChatJoinResult(Object):
    ...
    - :obj:`~pyrogram_styled.types.ChatJoinResultSuccess`
    - :obj:`~pyrogram_styled.types.ChatJoinResultRequestSent`
    - :obj:`~pyrogram_styled.types.ChatJoinResultGuardBotApprovalRequired`
    - :obj:`~pyrogram_styled.types.ChatJoinResultDeclined`
    """
...
class ChatJoinResultSuccess(ChatJoinResult):
    ...
    Parameters:
        chat (:obj:`~pyrogram_styled.types.Chat`):
...
class ChatJoinResultGuardBotApprovalRequired(ChatJoinResult):
    ...
    Parameters:
        bot (:obj:`~pyrogram_styled.types.User`):
            Information about the joined chat.
