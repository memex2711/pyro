...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~pyrogram_styled.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~pyrogram_styled.Client.sign_in` or :meth:`~pyrogram_styled.Client.sign_up`).

        next_type (:obj:`~pyrogram_styled.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~pyrogram_styled.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~pyrogram_styled.Client.resend_code`.
    """
