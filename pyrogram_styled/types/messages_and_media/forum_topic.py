...
class ForumTopic(Object):
    # todo
    # notify_settings: `~pyrogram_styled.types.PeerNotifySettings`
    # draft: `~pyrogram_styled.types.DraftMessage`
    """A forum topic.
    ...
    Parameters:
        ...
        from_id (:obj:`~pyrogram_styled.types.PeerChannel` | :obj:`~pyrogram_styled.types.PeerUser`):
            Topic creator.
