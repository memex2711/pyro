...
class MessageOrigin(Object):
    ...
    - :obj:`~pyrogram_styled.types.MessageOriginUser`
    - :obj:`~pyrogram_styled.types.MessageOriginHiddenUser`
    - :obj:`~pyrogram_styled.types.MessageOriginChat`
    - :obj:`~pyrogram_styled.types.MessageOriginChannel`
    - :obj:`~pyrogram_styled.types.MessageImportInfo`
