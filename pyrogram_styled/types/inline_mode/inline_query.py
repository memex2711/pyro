...
from pyrogram_styled import types, enums
...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~pyrogram_styled.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyrogram_styled.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyrogram_styled.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyrogram_styled.types.InlineQueryResult`):
