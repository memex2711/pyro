...
from pyrogram_styled.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update, ChosenInlineResult


class Filter:
    async def __call__(self, client: "pyrogram_styled.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyrogram_styled.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~pyrogram_styled.handlers.MessageHandler` the *update* argument will be a :obj:`~pyrogram_styled.types.Message`; in a :obj:`~pyrogram_styled.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyrogram_styled.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyrogram_styled.filters.command` or :meth:`~pyrogram_styled.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyrogram_styled.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyrogram_styled.types.Message`.
    ...
    async def func(flt, client: pyrogram_styled.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrogram_styled.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrogram_styled.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrogram_styled.types.InlineQuery`: The filter will match ``query``.
